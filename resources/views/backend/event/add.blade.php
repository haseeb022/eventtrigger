                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            @if ($errors->has('meeting_id'))
                              <span class="text-danger">{{ $errors->first('meeting_id') }}</span>
                            @endif
                          </div>
                        </div>
                      </div> -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="time" class="form-control" name="start_time" placeholder="00:00:00"/>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="time" class="form-control" name="end_time" placeholder="00:00:00"/>
                      ...
                      <!-- <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Is Event Free?</label>
                          <div class="col-sm-9">
