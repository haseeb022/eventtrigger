    ...
    <section class="hero-sec-v1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="left-content-hero" style="text-align: center !important">
                        <h1>The Leading Event Management Platform</h1>
            ...
            <div class="row gy-4">
                <div class="col-12">
                    <div class="sec-title text-white text-center">
                        <h4><img src="img/icon/title-icon-white.svg" data-aos="flip-left" data-aos-duration="1500" alt=""> Events Schedule</h4>
